...
def encode_commands(rt: bool, space: str, interface_type: str, target:str, gripper_command: float, pose_command: NDArray) -> bytes:
        '''
...
def encode_pose_feedback(status:str, space:str, 
                         end_effector_states:NDArray, 
                         camera_frame_states:NDArray, 
                         gripper_frame_states:NDArray)-> bytes:
       '''
